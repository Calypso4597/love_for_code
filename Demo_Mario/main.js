...
function preload() {
     ...
     game.load.tilemap('mario', 'assets/map1-1.json', null, Phaser.Tilemap.TILED_JSON);
...
function create() {
  ...
  map.setCollisionByIndex(40);
    ...
    mario.sprite = game.add.sprite(100, 217, 'mario');
  ...
  mario.sprite.body.collideWorldBounds = false;
